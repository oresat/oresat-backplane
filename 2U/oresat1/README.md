---
title: "**OreSat1 2U Backplane Fabrication and Assembly Information**"
subtitle: |
...
The OreSat1 2U Backplane is the backplane for a 2U CubeSat based on the open source [OreSat CubeSat system](https://www.oresat.org/). The backplane has:

- 40 pin main connnectors for Oresat-based cards
- Bus voltage (2S Lithium Ion batteries with a Vnom of 7.2V)
- Two CAN busses for inter-card communication
- RF lines using SMPM RF connectors and microstrips
- A debug connector to carry critical lines to the outside of the CubeSat
- Two cutouts for solar module connections

## Documentation Links

- OreSat Backplane hardware Git repository: <https://github.com/oresat/oresat-backplane>
- **TODO:** Backplane Design Notes + Design Review Notes
...
- 4 layer board
- Bounding box is 82.5 x 213.5 mm
...
- Plated/Un-plated holes
  ...
  - There are 4 un-plated (NPT) holes
- Outline/Routing
  - Requires a 1.0 mm or smaller diameter routing bit
- Slots/Cutouts
  - There are two slot/cutouts.
  - Requires a 1.0 mm or smaller diameter routing bit
...
- If not otherwise specified, PCB fabrication shall conform to IPC-6012, Class 2 or better. 
- If not otherwise specified, PCB acceptability criteria shall be via IPC-A-600, Class 2 or better.
...
- This PCBA is a mix of surface mount (SMT) and through hole (THT) components.

## Assembly Requirements

- Assembly shall conform to IPC J-STD-001 Class 2 or better.
- Inspection of assemblies shall be per IPC-A-610, Class 2 or better.
...
- SMPM connectors (CM*.*) should be hand-added before reflow.
