---
title: "**ESI/OreSat 3U Backplane Fabrication and Assembly Information**"
subtitle: |
...
The ESI/OreSat 3U Backplane is the backplane for a 3U backplane based on the open source [OreSat CubeSat system](https://www.oresat.org/). The backplane has:
...
- Four cutouts for solar module connections
...
- 4 layer board
- Bounding box is 82.5 x 327.0 mm
...
- Slots
  - There are no slots (although two cutouts have slot-like features)
- Cutouts
  - There are five cutouts.
...
- Not all connectors are placed, see BOM.
