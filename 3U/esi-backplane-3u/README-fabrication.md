# OreSat 3U Backplane Fabrication and Assembly Information

# Description

The OreSat 3U backplane is a 327 x 82.5 x 1.6 mm four layer PCB with a mix of 
...
- 4 layer board
   ...
   - Bounding box is 327 x 82.5 x 1.6 mm
- Design Rules
...
- Plated/Un-plated holes
  ...
  - There are 2,630 plated through (PTH) holes
  - PTH minimum diameter: 0.254 mm (10 mil)
  - PTH minimum annulus: 0.102 mm (4 mil) radius
- Slots
  - There 4 interior unplated slots
  - Minimum un-plated slot width is 1.0 mm (39.4 mil)
